        ...
        <>
            <div className='h-screen w-screen  flex flex-col items-end font-montserrat '>
                ...
                <div className="  w-full lg:h-[90%] h-[90%] flex flex-col justify-start lg:items-start items-center overflow-y-scroll overflow-scroll px-[5%] ">
                    ...
                    <div className='w-[100%] h-[90%]   flex flex-col lg:flex-row justify-center items-center text-center font-bold text-xl ' >
                        ...
                        <div className='w-[100%] h-[50%] lg:h-[100%]   flex flex-col justify-center lg:justify-start lg:items-end lg:pt-[2%] items-center text-center lg:text-end font-thin text-sm lg:text-3xl text-[#c266d3] ' >
            ...
            <div className='w-[100vw] h-[100vh]    font-montserrat px-[5%]' >
                ...
                <div className='w-[100%] h-[90%]   flex flex-col lg:flex-row-reverse justify-center items-center text-center font-bold text-xl ' >
                    ...
                    <div className='w-[100%] h-[50%] lg:h-[100%]   flex flex-col justify-center lg:justify-start lg:pt-[5%] items-center text-center lg:text-start font-thin text-sm lg:text-3xl text-[#c266d3]  ' >
            ...
            <div className='w-[100vw] h-[100vh]    font-montserrat px-[5%] ' >
                ...
                <div className='w-[100%] h-[90%]   flex flex-col lg:flex-row justify-center items-center text-center font-bold text-xl ' >
                    ...
                    <div className='w-[100%] h-[40%] lg:h-[100%]   flex flex-col justify-center lg:justify-start lg:pt-[5%] items-center text-center lg:text-end font-thin text-sm lg:text-3xl text-[#c266d3] ' >
